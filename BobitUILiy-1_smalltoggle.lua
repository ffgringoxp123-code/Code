...
function Window:Tab(config)
        ...
        function Tab:CreateModule(mConfig)
            ...
            local ToggleBg = New("Frame", {
                Size = UDim2.new(0, s(24), 0, s(13)),
                Position = UDim2.new(1, -s(34), 0.5, -s(6)),
                BackgroundColor3 = Color3.fromRGB(40, 40, 45),
            }, Header)
            Round(ToggleBg, s(999))
            local ToggleDot = New("Frame", {
                Size = UDim2.new(0, s(9), 0, s(9)),
                Position = UDim2.new(0, s(2), 0.5, -s(4.5)),
            ...
            local function setEnabled(state, fromUser)
                ...
                Tween(ToggleDot, {
                    Position = state and UDim2.new(0, s(13), 0.5, -s(4.5)) or UDim2.new(0, s(2), 0.5, -s(4.5)),
